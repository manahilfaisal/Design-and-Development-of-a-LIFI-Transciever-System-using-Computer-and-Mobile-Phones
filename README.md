...
### **Stage 2: Reception & Data Acquisition (ADC Simulation)**[document (2).pdf](https://github.com/user-attachments/files/25162196/document.2.pdf)
...
* **Data Export:** Recorded lux values are exported as a **CSV file**, which serves as the input for the decoding process.
...
* **Python Libraries:** `pandas`, `nump[document (2).pdf](https://github.com/user-attachments/files/25162205/document.2.pdf)
y`, `matplotl[document (2).pdf](https://github.com/user-attachments/files/25162203/document.2.pdf)
ib`, `scipy`, `tkinter`
